...
class InfixNotEqualsOperatorTest extends BaseEvaluationTest {
  ...
  void testInfixNotEqualsStructures() throws EvaluationException, ParseException {
    ...
    Map<String, BigDecimal> structure1 = new HashMap<String, BigDecimal>() {{
      put("a", new BigDecimal(35));
      put("b", new BigDecimal(99));
    }};

    Map<String, BigDecimal> structure2 = new HashMap<String, BigDecimal>() {{
      put("a", new BigDecimal(35));
      put("b", new BigDecimal(99));
    }};

    Map<String, BigDecimal> structure3 = new HashMap<String, BigDecimal>() {{
